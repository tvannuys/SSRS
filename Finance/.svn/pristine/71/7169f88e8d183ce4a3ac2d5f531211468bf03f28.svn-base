...
ALTER PROC [dbo].[JT_new_claims_v2] AS
...
SELECT CCS.Customer, CCS.CustName, LD.Vendor, LD.Division, LD.Item, LD.[Description], LD.Quantity, LD.Amount, CCS.[Date], LD.Company, LD.Location, LD.[Order], CCS.Comment 
