/* GMROI review for Will CritesSR 6765
http://inventorycurve.com/GMROI.html
Action:  See scanned paperwork from Will - Validate where summation of avg inventory makes calculations in valid
Direct ship orders from vendor:  

- HUD from Tuesday, January 15, 2013 ; 
 George Rippee wrote [4:03 pm] SHOTYP = FO or FS or SD  alternately SLDIRS=Y
