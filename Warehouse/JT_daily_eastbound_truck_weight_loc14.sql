...
/****** Object:  StoredProcedure [dbo].[JT_daily_eastbound_truck_weight_loc14]    Script Date: 07/17/2012 12:28:41 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROC [dbo].[JT_daily_eastbound_truck_weight_loc14] AS
  BEGIN
	SELECT * 
	FROM OPENQUERY(GSFL2K,
		...
		WHERE (oh.ohrout IN (''50-14'',''41-14'',''57-14'',''302'',''302P'',''302S'')  OR (rt.ortrt IN( ''50-14'',''302'')))
