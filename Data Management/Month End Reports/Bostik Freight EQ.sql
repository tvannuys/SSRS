...
SELECT	GSFL2K.POLHIST.PLCO AS Company, 
		...
		GSFL2K.POLHIST.PLQREC AS QtyReceived, 
		GSFL2K.ITEMMAST.IMWGHT AS UnitWeight, 
		GSFL2K.POLHIST.PLFACT AS UnitFactor, 
		GSFL2K.POLHIST.PLRDAT AS ReceiptDate, 
		GSFL2K.POLHIST.PLCOST AS UnitCost, 
		((IMWGHT*PLFACT)*PLQREC) AS TotalLineWeightRecd, 
		(((IMWGHT*PLFACT)*PLQREC)*0.04) AS TotalLineFreightEQ
