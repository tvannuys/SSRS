...
/****** Object:  StoredProcedure [dbo].[InboundFrieghtPM]    Script Date: 02/01/2013 11:45:05 ******/
SET ANSI_NULLS ON
GO
...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[InboundFrieghtPM]') AND type in (N'P', N'PC'))
BEGIN
