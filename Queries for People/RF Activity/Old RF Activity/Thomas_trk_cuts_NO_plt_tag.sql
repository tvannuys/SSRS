...
--
-- 1/27/2012 as of now all roll for xe and trucks are tied to a pallet tag
-- and shipped of the pallet tag. When testing the ones that did show up were because
-- the order was undone and the pallet tag was set to zero
-- Also UPS or Common CArrier Route could be in this
--
-- Shipped | Cuts | NO Pallet Tag | VIA Code NOT 1 (Will Call) or 6 (Pre-pull W/Call)
------------------------------------------------------------------------------------
------------------------------------------------------------------------------------
...
---------------------------------------------------------------------------------------
--*************************************************************************************
SELECT CTE.[User], CTE.Name, CTE.NonPlt AS Trk_Cuts
FROM CTE
